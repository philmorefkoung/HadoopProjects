...
public class AverageTemperature2 {
    ...
    public static class TokenizerMapper extends Mapper<Object, Text, Text, DoubleWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (tokens.length >= 8) {
                ...
                String yearVal = tokens[6];
                double avgTemp = Double.parseDouble(tokens[7]);
                if(regionName.equals("Asia") && avgTemp != -99) {
                	yearCountry.set(countryName + " " + yearVal);
                	temperature.set(avgTemp);
                	context.write(yearCountry, temperature);
                }
            }
